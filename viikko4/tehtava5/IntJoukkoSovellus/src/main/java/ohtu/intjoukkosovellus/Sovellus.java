...
public class Sovellus {
    ...
    private static void lisaaLukuJoukkoon() {
        int lisLuku;
        IntJoukko joukko;
        Scanner lukija = new Scanner(System.in);
    ...
    private static void poistaLukuJoukosta() {
        IntJoukko joukko;
        int lisLuku;
        Scanner lukija = new Scanner(System.in);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Komennot ovat lisää(li), poistaLukuJoukosta(p), kuuluu(k), yhdiste(y), erotus(e), leikkaus(le) ja lopetus(quit)(q).");
        ...
        while (true) {
            ...
            if (luettu.equals("lisää") || luettu.equals("li")) {
                lisaaLukuJoukkoon();
            } else if (luettu.equalsIgnoreCase("poistaLukuJoukosta") || luettu.equalsIgnoreCase("p")) {
                poistaLukuJoukosta();
                ...
                System.out.println("Komennot ovat lisää(li), poistaLukuJoukosta(p), kuuluu(k), yhdiste(y), erotus(e) ja leikkaus(le).");
            }
            System.out.println("Komennot ovat lisää(li), poistaLukuJoukosta(p), kuuluu(k), yhdiste(y), erotus(e) ja leikkaus(le).");
        }
    }
